    ...
    return(
      <div className="RecipeContainer">
        ...
        <div className="RecipeRightArea">
          ...
          {this.state.isState ? <RecipeComment value={this.state.selectedRecipe}/> 
          : <LatestSixView value={this.state.RecipeSearchInput} list={this.state.recipeList} function={this.handelselectedRecipe}/>}
